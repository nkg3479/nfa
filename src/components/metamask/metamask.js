...
export default function Meta(){
    ...
    return(
        <Container className="bod">
            <Row><Col>
            <Row style={{marginLeft:"10px"}}><span className="hd1">Connect to Your Metamask Account</span></Row>
            <Row>
                <Col>
                    <Button className='bt1' onClick={connect}>Connect to Metamask</Button>
                </Col>
            </Row>
            <Row><Col>{active ?<span>Connected with <b>{account}</b></span>:<span>Not Connected</span>}</Col></Row>
            <Row>
                <Col>
                    <Button className='bt1' onClick={disconnect}>Disconnect</Button>
                </Col>
